...
try:
    ...
    # fallback when launched from a flat repo layout
...
async def run_discovery_cycle(
    ...
    if merged:
        try:
            await enrich_tokens_with_price_change(session, merged, logger, set(), {})
        except Exception as e:
            logger.warning("Price enrichment skipped (error): %s", e)
