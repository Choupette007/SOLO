...
async def refresh_token_cache(max_items: Optional[int] = None) -> int:
    """
    Forward stub for refresh_token_cache so callers defined earlier in the module
    (e.g. _refresh_token_cache_safely, schedule_refresh_token_cache) do not
    trigger "not defined" diagnostics. The full implementation follows later in this module.
    """
    raise NotImplementedError("refresh_token_cache real implementation defined later in this module")
...
from .utils import safe_create_task  # robust scheduler that handles sync contexts
