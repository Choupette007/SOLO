...
async def _enrich_shortlist_with_signals(tokens: List[Dict[str, Any]], cfg: dict | None = None) -> List[Dict[str, Any]]:
    """
    Enrich tokens with signals (batch OHLCV + patterns + BBands).
    ...
    Returns:
        List of enriched tokens (or original tokens on failure)
    """
    ...
    try:
        ...
        # Compute signals config once at function start
            ...
            if signals_enabled and patterns_enabled:
                ...
                try:
                    if candidate_for_batch:
                        ...
                        batch_summary["n_attempted"] = len(candidate_for_batch)
                except Exception as e:
                ...
                try:
                    ...
                    logger.debug("Failed to record batch coverage metrics", exc_info=True)
